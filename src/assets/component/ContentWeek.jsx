						...
						<div className="mx-5 px-5 mt-md-0 mt-sm-5 pt-md-0 pt-sm-5">
							<div className="d-flex flex-md-row flex-sm-column bd-highlight py-5" style={{justifyContent: 'space-between'}}>
								<div className="d-flex m-md-0 justify-content-sm-center mb-sm-5">
									...
									<button className="ml-3 btn btn-primary" style={{position: 'relative'}} onClick={this.alert}><i class="fas fa-plus"></i>&nbsp;&nbsp;Create new</button>
								</div>
								<div className="d-flex bg-gray p-2 rounded" style={{justifyContent: 'space-around'}}>
									...
									<button className="btn px-3 py-1 btn-light-mat hover-shadow shadow-md">Week</button>
									<Link to="/eventcalendar/month">
										<button className="btn px-3 py-1 bg-gray" style={{color: 'gray'}}>Month</button>
									</Link>
								</div>
							</div>
						<div className="row">
							<div className="wow slideInUp col-xl-4 col-lg-12 col-md-12 col-sm-12 mb-sm-5" wow-data-delay="0.3s">
								<div className="card rounded-lg shadow-md hover-shadow border-0 p-4">
									<div className="card-title p-2">
										<h3 style={{fontWeight: 'bold'}}>Week 1</h3>
							...
							<div className="wow slideInUp col-xl-4 col-lg-12 col-md-12 col-sm-12 mb-sm-5" data-wow-delay="0.6s">
								<div className="card rounded-lg shadow-md hover-shadow border-0 p-4">
									<div className="card-title p-2">
										<h3 style={{fontWeight: 'bold'}}>Week 2</h3>
							...
							<div className="wow slideInUp col-xl-4 col-lg-12 col-md-12 col-sm-12 mb-sm-5" data-wow-delay="0.9s">
								<div className="card rounded-lg shadow-md hover-shadow border-0 p-4">
									<div className="card-title p-2">
										<h3 style={{fontWeight: 'bold'}}>Week 3</h3>
