		...
		return (
			<div className="masthead">
				<div className="wow fadeIn row m-0" data-wow-delay="0.3s">
					<div className="col-md-12 col-lg-12 col-xl-10 m-0 p-0">
						<div className="mx-3 px-4 mt-md-0 mt-sm-3 pt-md-0 pt-sm-3">
							<div className="d-flex flex-md-row flex-sm-column heading bd-highlight mt-5 mb-4" style={{justifyContent: 'space-between'}}>
								...
								<div className="d-flex bg-gray p-1-set rounded" style={{justifyContent: 'space-around'}}>
									<button className="btn px-3 p-1-set btn-light-mat h7 hover-shadow shadow-md">Day</button>
									<Link to="/eventcalendar/week">
									<button className="btn px-3 h7 p-1-set bg-gray" style={{color: 'gray'}}>Week</button>
									</Link>
									<Link to="/eventcalendar/month">
										<button className="btn h7 px-3 p-1-set bg-gray" style={{color: 'gray'}}>Month</button>
									</Link>
								</div>
							</div>
							<div className="body">
						<section className="scroll-new">
							...
							<div className="wow slideInUp content--scroll" data-wow-delay="0.6s">
								<div className="card rounded shadow-md hover-shadow border-0 p-3">
									<div className="card-title p-2">
										<h6>03<small>rd</small> Thursday</h6>
										<div className="progress mt-3 mb-3" style={{height: '4px'}}>
										...
										<div className="card rounded mt-4">
											<div className="card-body p-3">
												<label className="text-disable roboto-sm">11:00 AM - 11:30 AM</label>
												<p className="mt-1 roboto-md">Website for the Product</p>
												<div className="d-flex justify-content-between mt-1 align-items-center">
													<div className="text-left mt-2">
														...
														<div className="btn shadow-sm btn-warning-smooth font-md ">
															ES
														</div>
													</div>
													<div className="text-right font-md">
										...
										<div className="card rounded mt-3 border">
											<div className="card-body p-3">
												<label className="text-disable roboto-sm">11:00 AM - 11:30 AM</label>
												<p className="mt-1 roboto-md">Hey you guys we need to do this and that too <span role="img" aria-label="image">&#9996;</span> </p>
												<div className="row mt-1">
													<div className="col-8 text-left mt-2">
														...
														<div className="btn shadow-sm btn-danger-smooth font-md px-2 mr-1">
															LA
														</div>
														<div className="btn shadow-sm btn-primary-smooth font-md px-2 mr-1">
															AM
														</div>
														<div className="btn shadow-sm btn-lavender-smooth font-md px-2 mr-1">
															FS
														</div>
													</div>
												</div>
					...
					<div className="wow slideInUp col-md-12 col-lg-12 col-xl-2 m-0 p-0">
						<RightSession/>
					</div>
				</div>
			</div>
